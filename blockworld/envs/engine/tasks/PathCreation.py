...
from blockworld.envs.tasks.Task import Task
from blockworld.envs.game_config import *
from blockworld.envs.ActionSet import *
...
class Path_Creation(Task):
    def __init__(self):
        ...
        # Make a list for the backend to work with
        #self.legal_actions = range(len(self.actions))
