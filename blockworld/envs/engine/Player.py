...
class Player(object):
    ...
    def __init__(self):
        ...
        self.actions = blockworld.envs.engine.ActionSet.GAME_ACTIONS

        # self.task = TASK # task is defined in the task script
